...
import { BusLaneFilterParams } from "@/types/models/bus-lane";

interface BusLaneFilterDialogProps {
  currentInputs: BusLaneFilterParams;
  onInputChange: (
    name: string,
...
export const BusLaneFilterDialog: FC<BusLaneFilterDialogProps> = ({
  currentInputs,
  onInputChange,
  onSearch,
  isOpen,
